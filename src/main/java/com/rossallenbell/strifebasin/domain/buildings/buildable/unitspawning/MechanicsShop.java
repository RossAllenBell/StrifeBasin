...
import com.rossallenbell.strifebasin.domain.units.Ballista;
import com.rossallenbell.strifebasin.domain.units.PlayerUnit;
import com.rossallenbell.strifebasin.ui.resources.HasImage;

@HasImage
@AdvancedBuilding
public class MechanicsShop extends UnitSpawingBuilding {
    
    public MechanicsShop(Me owner) {
        super(owner);
    }
